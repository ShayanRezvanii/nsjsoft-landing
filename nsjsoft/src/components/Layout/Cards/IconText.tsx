...
function IconText({ children, iconCard, bgIconColor }: IconTextProps) {
  return (
    <div className=" w-full lg:max-w-[262px] h-[269px] text-center border border-white/20 text-3xl xl:text-2xl flex flex-col justify-center items-center gap-4 bg-b text-white shadow-black/10 rounded-3xl shadow-lg">
      <div
